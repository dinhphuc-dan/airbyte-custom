...
class AppsFlyerIAPRawOrganic(AppsflyerCustomStream, IncrementalMixin):
    primary_key = None
    ...
    @property
    def name(self) -> str:
        """Override method to get stream name according to each app name with suffix IAP Raw Organic """
