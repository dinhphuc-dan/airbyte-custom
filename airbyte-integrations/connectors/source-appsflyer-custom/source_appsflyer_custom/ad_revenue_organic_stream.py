...
class AppsFlyerAdRevenueRawOrganic(AppsflyerCustomStream, IncrementalMixin):
    primary_key = None
    ...
    @property
    def name(self) -> str:
        """Override method to get stream name according to each app name with suffix Ad Revenue Raw Organic """
