...
import pytest
from source_volio_store.source import VolioStoreStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(VolioStoreStream, "path", "v0/example_endpoint")
    mocker.patch.object(VolioStoreStream, "primary_key", "test_primary_key")
    mocker.patch.object(VolioStoreStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = VolioStoreStream()
